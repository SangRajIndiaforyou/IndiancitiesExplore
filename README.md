...
<head>
    ...
    <style>
        ...
        .cities { padding: 2rem; text-align: center; background-color: #fff; }
        ...
        .card {
            background-color: #fff; border: 2px solid #128807; border-radius: 8px;
        ...
        .card button {
            background-color: #128807; color: #fff; border: none; padding: 0.5rem 1rem;
            cursor: pointer; margin-bottom: 1rem; border-radius: 4px; font-weight: bold;
        ...
        .close:hover, .close:focus { color: black; cursor: pointer; transform: scale(1.2); }
        .modal h2 { color: #FF9933; margin-bottom: 1rem; }

        .tabs { display: flex; justify-content: center; margin-bottom: 1rem; flex-wrap: wrap; }
        .tab-button {
            background-color: #fff; border: 2px solid #128807; color: #128807;
            padding: 0.5rem 1rem; cursor: pointer; border-radius: 4px 4px 0 0;
            font-weight: bold; margin: 0.2rem; transition: 0.3s ease;
        }
        .tab-button:hover { background-color: #128807; color: #fff; transform: translateY(-2px); }
        .tab-button.active { background-color: #128807; color: #fff; }
        .tab-content { display: none; padding: 1rem; border: 2px solid #128807; border-radius: 0 4px 4px 4px; background-color: #f9f9f9; animation: fadeInContent 0.3s ease; }
        @keyframes fadeInContent { from { opacity: 0; } to { opacity: 1; } }
        .tab-content.active { display: block; }
        .tab-content ul { list-style: none; padding: 0; }
        .tab-content li { margin: 0.5rem 0; transition: transform 0.3s ease; }
        .tab-content li:hover { transform: translateX(5px); }
...
<section class="cities" id="destinations">
    ...
    <div class="card-container">
        <div class="card">
            <img src="https://images.unsplash.com/photo-1597784333620-0a7b17d1ed68?auto=format&fit=crop&w=800&q=60" alt="Delhi">
            <h3>Delhi</h3>
        ...
        <div class="card">
            <img src="https://images.unsplash.com/photo-1536648032880-75364a0b53eb?auto=format&fit=crop&w=800&q=60" alt="Mumbai">
            <h3>Mumbai</h3>
        ...
        <div class="card">
            <img src="https://images.unsplash.com/photo-1591899865339-3f7f1d7a6468?auto=format&fit=crop&w=800&q=60" alt="Bangalore">
            <h3>Bangalore</h3>
        ...
        <div class="card">
            <img src="https://images.unsplash.com/photo-1587814553134-ff9c745f2a45?auto=format&fit=crop&w=800&q=60" alt="Chennai">
            <h3>Chennai</h3>
        ...
        <div class="card">
            <img src="https://images.unsplash.com/photo-1606995507260-dc0b378df0f3?auto=format&fit=crop&w=800&q=60" alt="Kolkata">
            <h3>Kolkata</h3>
...
document.querySelectorAll('.explore-btn').forEach(button=>{
    button.addEventListener('click', function(){
        ...
        if(city){
            ...
            populateList(foodList, city.food);
            populateList(sightseeingList, city.sightseeing);
            populateList(templesList, city.temples);
            populateList(shoppingList, city.shopping);
